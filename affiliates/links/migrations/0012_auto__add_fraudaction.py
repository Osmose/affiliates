...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FraudAction'
        db.create_table(u'links_fraudaction', (
            ...
            ('executed_on', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('reversed_on', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
        ))
        db.send_create_signal(u'links', ['FraudAction'])


    def backwards(self, orm):
        # Deleting model 'FraudAction'
        db.delete_table(u'links_fraudaction')
    ...
    models = {
        ...
        u'links.fraudaction': {
            ...
            'reversed_on': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'})
        },
